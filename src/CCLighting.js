    ...
    return (
        <>
            ...
            <div style={{backgroundColor:'#005C7A', minHeight:'90vh', height:'100%', display:'flex',flexwrap:'wrap', flexDirection:'column', alignItems:'center'}}>
                ...
                was the use of emailJS for the contact page. It is very interesting to see how there is almost a tool for everything out there, you just have to do some digging and you can find
                some cool things.
                <br /> <br />
