...
const jetImg = "https://clipartix.com/wp-content/uploads/2016/04/Airplane-air-plane-clip-art-clipart-5-clipartwiz.png";
    ...
    return (
      <div className="about-section">
        ...
        immediately after I left the Air Force.</p>
          ...
          <div>
          <img src={computerImg} alt="picture of a computer" style={{ width: 300, height: 300 }} />
        ...
        and I am excited to see where the road carries me.</p>
          ...
          <div>
          <img src={thoughtImg} alt="picture of a thought bubble" style={{ width: 300, height: 300 }} />
        ...
        version with my own modifications. It felt really cool to create something from nothing using only the tools I had taught myself. Moving forward,
         I have been self-teaching through Codecademy and am excited to see where this takes me.</p>
          ...
          <div>
          <img src={stickyNoteImg} alt="picture of a sticky note saying thank you" style={{ width: 300, height: 300 }} />
          <p>Now that I am getting back into programming,
        ...
        from past work that I have been completing to advance my learning. If you have read this far, I want to personally thank you! There is a form at the bottom of this page for any feedback that you may recommend
