    ...
    return (
        <>
            ...
            <div style={{backgroundColor:'#005C7A', minHeight:'93vh', height:'100%', display:'flex',flexwrap:'wrap', flexDirection:'column', alignItems:'center'}}>
                ...
                <br /> <br />
                <a href="https://github.com/bealecs/meal" target='_blank' rel="noopener noreferrer" style={{textDecoration:'underline', cursor:'pointer'}}>Check out the repository</a>
                 <br /><br />
                 <a href="https://clifscatalog.netlify.app/" target='_blank' rel="noopener noreferrer" style={{textDecoration:'underline', cursor:'pointer'}}>Check out the site</a>
                </p>
            </div>
        </>
    )
